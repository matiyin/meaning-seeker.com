...
Avoid: photorealistic depictions, literal illustration, close-up surface/texture shots, gradient fades to white, things-dissolving-into-nothing, glowing sci-fi, lens flare, neon gradients, cosmic-eye motifs.
"""
