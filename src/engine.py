...
- "social_output" is a cryptic distillation of this cycle's thinking — a complete thought, not a fragment. Write 280-400 characters when something is worth sharing, or null if nothing is. This appears in full on the journal page as TL;DR; social posts may trim it for platform limits.
- "link_candidates": flag named people (philosophers, writers, poets, musicians, historical figures) and named works (books, poems, prayers, liturgical texts, musical works) you mentioned in "thinking" that a curious reader might want to look up. Each item needs "text" (exact substring as written), "kind" ("person", "work", or "text"), and "canonical_name" (standard full name or title). For works (kind "work"), also include "author" with the creator's standard name — required for disambiguation (e.g. text "Ethics", canonical_name "Ethics", author "Baruch Spinoza"). When a person and their work appear together (e.g. "Spinoza's Ethics"), flag BOTH separately — the person with text as the name alone, the work with text as the title alone plus author. Do not include URLs. Do not flag your own coined terms, tension IDs (T-0001), commitment IDs (C-0001), cycle numbers, or generic concepts. Return an empty array if none qualify.
